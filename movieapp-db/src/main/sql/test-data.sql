...
INSERT INTO movieapp.movies (id, uuid, title, duration, storyline, poster_url, trailer_url, wiki_url, release_at, censor_board_rating, rating, status)
        VALUES
        (1, '7d174a25-ba31-45a8-85b4-b06ffc9d5f8f', 'Sanju', 162, 'Coming from a family of cinematic legends, East Indian actor Sanjay Dutt reaches dizzying heights of success -- but also battles numerous addictions and other personal demons', 'https://upload.wikimedia.org/wikipedia/en/8/85/Sanju_poster.jpg', 'https://www.youtube.com/watch?v=1J76wN0TPI4', 'https://en.wikipedia.org/wiki/Sanju', '2018-06-29 00:00:00', 'UA', 4.0, 'RELEASED'),
